...
$datos = $factura->getProductos();
foreach ($datos as $row) {
    
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetX(18);
    $pdf->Cell(35, 6, utf8_decode($row['nombre_prod']), 1, 0, 'C');
    $pdf->Cell(35, 6, utf8_decode($row['modelo_prod']), 1, 0, 'C');
    $pdf->Cell(35, 6, $row['precio_prod'], 1, 0, 'C');
    $pdf->Cell(35, 6, $row['cantidad_prod'], 1, 0, 'C');
    $pdf->Cell(35, 6, $row['nombre_prov'], 1, 0, 'C');
    $pdf->Ln(6);
}
