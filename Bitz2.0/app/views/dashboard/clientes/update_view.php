        ...
        <div class="col s12 m12 offset-l3 l9">
            <div class="card ">
                <div class="card-content">
                    <span class="card-title pad-top-conv">Modificando proveedores</span>
                    <div class="divider"></div>
                    <div class="row">
                        <form method="POST" class="col s12 m12 l12">
                            <div class="row">
                                <div class="input-field col s12 m6 l6">
                                    <input name="nombre" id="first_name" type="text" autocomplete = 'off' class="validate" value="<?php print($proveedor->getNombre()); ?>" required>
