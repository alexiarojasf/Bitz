                        ...
                        <form class="col s12 m12 l12" method="post">
                            <div class="row">
                                ...
                                <div class="col s12 m4 l4 right">
                                    ...
                                    <a id="button-margin" class="waves-effect waves-light btn but-blue-green" href="../../dashboard/reportes/stock_productos.php"><i class="material-icons white-text">class</i></a>
                                </div>
                                <div class="row">
                                ...
                                <table class="striped " id="tablaScroll" class="striped display" data-order='[[ 1, "asc" ]]' data-page-length='10'>
                                    ...
                                    <div class="divider"></div>
                                    <span class="card-title pad-top-conv">Datos estadísticos</span>
                                    <div class="divider"></div>
                                    <div class="col s12 m6 l6">
                                        <h5>Cantidad de productos vendidos</h5>
                                        <canvas id="instock"></canvas>
                                    </div>
                                    <div class="col s12 m6 l6">
                                        <h5>Productos existentes por categoria</h5>
