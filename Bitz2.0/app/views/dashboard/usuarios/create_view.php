                    ...
                    <div class="row">
                        <form method="POST" class="col s12 m12 l12">
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6 l6">
                                    <input id="nombre" type="text" class="validate" name="nombre" value="<?php print($usuario->getNombres())?>" onkeypress="return soloLetras(event)">
                                    <label for="nombre">Nombres</label>
                                </div>
                                <div class="input-field col s12 m6 l6">
                                    <input id="apellido" type="text" class="validate" name="apellido" value="<?php print($usuario->getApellidos())?>" onkeypress="return soloLetras(event)">
                                    <label for="apellido">Apellidos</label>
                                </div>
                                <div class="input-field col s12 m6 l6">
                                    <input id="telefono" type="text" class="validate" name="telefono" value="<?php print($usuario->getTelefono())?>"  data-length="8" maxlength="8" onkeypress="return valida(event)">
                                    <label for="telefono">Teléfono</label>
                                </div>
                                <div class="input-field col s12 m6 l6">
                                    <input id="contra1" type="password" class="validate" name="clave1"  value="">
                                    <label for="contra1">Contraseña</label>
                                </div>
                                <div class="input-field col s12 m6 l6">
                                    <input id="contra2" type="password" class="validate" name="clave2" value="">
