                    ...
                    <div class="row">
                        <form method="POST" class="col s12 m12 l12">
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6 l6">
                                    <input id="nombre" type="text" class="validate" name="nombre" onkeypress="return soloLetras(event)">
                                    <label for="nombre">Nombres</label>
                                </div>
                                <div class="input-field col s12 m6 l6">
                                    <input id="apellido" type="text" class="validate" name="apellido" onkeypress="return soloLetras(event)">
                                    <label for="apellido">Apellidos</label>
                                </div>
                                <div class="input-field col s12 m6 l6">
                                    <input id="telefono" type="text" class="validate" name="telefono" data-length="8" maxlength="8" onkeypress="return valida(event)">
